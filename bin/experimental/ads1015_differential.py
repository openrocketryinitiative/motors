...
GAIN = 16
RATE = 3300 #128, 250, 490, 920, 1600, 2400, 3300
while True:
    ...
    value = adc.read_adc_difference(0, gain=GAIN, data_rate=RATE)
    ...
    print('Channel 0 minus 1: {} at {} hz.'.format(value, 1./(time.time() - start_time)))
